...
const displayStr = `A total of $${totalAmountRaised.toLocaleString('en-US')} has been raised for 
${GAMES_JSON.length} games. Currently, ${unfundedCount === 1 ? "1 game" : `${unfundedCount} games`} 
...
moreInfoElement.innerHTML = displayStr;
descriptionContainer.appendChild(moreInfoElement);
